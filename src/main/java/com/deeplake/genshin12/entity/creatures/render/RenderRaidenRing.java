...
public class RenderRaidenRing extends Render<EntityRaidenRing> {
    ModelRaidenRingVer1 modelRaidenRing = new ModelRaidenRingVer1();
    public static final ResourceLocation RES_LOC = new ResourceLocation(Reference.MOD_ID + ":textures/entity/texture_ring.png");
    public RenderRaidenRing(RenderManager renderManager) {
        super(renderManager);
    }
