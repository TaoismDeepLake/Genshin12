...
public class VTradeItemToItem implements EntityVillager.ITradeList {
    ...
    //Item X-Z Version
    public VTradeItemToItem(Item buyingItemStack, EntityVillager.PriceInfo buyingPriceInfo, Item sellingItemstack, EntityVillager.PriceInfo sellingPriceInfo) {
        this(new ItemStack(buyingItemStack),buyingPriceInfo,ItemStack.EMPTY, PRICE_ONE, new ItemStack(sellingItemstack), sellingPriceInfo);
    }
    ...
    public VTradeItemToItem(CostType costType, EntityVillager.PriceInfo costPriceInfo, Item resultStack) {
        this(costType, costPriceInfo, new ItemStack(resultStack), PRICE_ONE);
    }
    ...
    public VTradeItemToItem(CostType costType, Item resultStack, int count) {
        this(costType, PRICE_ONE, new ItemStack(resultStack), new EntityVillager.PriceInfo(count, count));
    }
