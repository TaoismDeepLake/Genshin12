...
import static com.deeplake.genshin12.util.NBTStrDef.IDLNBTDef.STATE;
import static com.deeplake.genshin12.util.NBTStrDef.IDLNBTUtil.GetInt;
import static com.deeplake.genshin12.util.NBTStrDef.IDLNBTUtil.SetInt;

public class ItemHateDetector extends ItemSkillBase {

    private Class<? extends EntityLiving> targetCategory = EntityLiving.class;
    private String msgKey = "genshin12.msg.being_targeted";
