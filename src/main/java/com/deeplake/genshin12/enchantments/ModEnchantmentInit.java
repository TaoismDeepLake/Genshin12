...
public class ModEnchantmentInit {
    ...
    //Example Enchant
//    public static final ModEnchantmentBase ANTI_VANILLA = new ModEnchantmentBase("genshin12.anti_vanilla", Enchantment.Rarity.UNCOMMON, EnumEnchantmentType.WEAPON,  mainHand)
